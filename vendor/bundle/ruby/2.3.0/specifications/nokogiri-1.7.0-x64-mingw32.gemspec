# -*- encoding: utf-8 -*-
# stub: nokogiri 1.7.0 x64-mingw32 lib
...
Gem::Specification.new do |s|
  ...
  s.post_install_message = "Nokogiri is built with the packaged libraries: libxml2-2.9.4, libxslt-1.1.29, zlib-1.2.8, libiconv-1.14.\n".freeze
  s.rdoc_options = ["--main".freeze, "README.md".freeze]
  s.required_ruby_version = Gem::Requirement.new(["< 2.4".freeze, ">= 2.1.0".freeze])
